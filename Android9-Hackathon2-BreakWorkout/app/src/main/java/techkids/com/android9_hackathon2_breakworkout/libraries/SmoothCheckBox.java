package techkids.com.android9_hackathon2_breakworkout.libraries;
...
//    private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#DFDFDF");
    ...
    private static final int COLOR_TICK = Color.parseColor("#6EC05D");
    private static final int COLOR_UNCHECKED = Color.WHITE;
    private static final int COLOR_CHECKED = Color.parseColor("#FB4846");
    private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#d6d1d1");
